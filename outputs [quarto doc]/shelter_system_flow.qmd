...
R [@citeR], R packages "tidyverse" [@citetidyverse], "dplyr" [@citedplyr], "janitor" [@citejanitor], "here" [@citehere], and "knitr" [@citeknitr] are used to produce an extract of the cleaned dataset.
